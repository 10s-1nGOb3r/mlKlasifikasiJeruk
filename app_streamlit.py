...
model_path = os.path.join(current_dir, "model_klasifikasi_jeruk.joblib")

#Load Up The Job Lib That's Been Created
model = joblib.load(model_path)

#Some Titles and Acknowldegments
...
#Some Parameters to be Passed On
...
#The Button to Ignite The Machine Learning on joblib
...
#I would say the footer and pay some hoomage to our lovely homie
st.divider()
